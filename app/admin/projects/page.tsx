              ...
              >
                <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                  <div className="flex gap-5">
                    <div className="relative hidden h-28 w-36 shrink-0 overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-indigo-500/20 via-black to-purple-500/20 md:block">
                      {project.coverImage ? (
                        <>
                          <Image
                        ...
                        <div className="absolute inset-4 rounded-2xl border border-white/10 bg-black/40" />
                      )}
                    </div>
